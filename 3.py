...
class Position(Worker):
    ...
    def get_total_income(self):
        print(f'Общий доход составляет {sum(self._income.values())}')

main_worker = Position('Olga', 'Timofeeva', 'CEO', 35000, 15000)
main_worker.get_full_name()
print(main_worker.surname)
main_worker.get_total_income()